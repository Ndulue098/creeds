...
export default function NewsLetter() {
  return (
 <section className="max-w-6xl mx-auto my-20 grid grid-cols-1 md:grid-cols-[55fr_45fr] gap-10 items-stretch px-6">
  {/* Left Section */}
  <motion.div
    initial={{ opacity: 0, y: 20 }}
    whileInView={{ opacity: 1, y: 0 }}
    transition={{ duration: 0.6 }}
    className="border border-green-200 rounded-lg p-10 flex flex-col justify-center bg-gradient-to-br from-green-50 via-white to-green-100 shadow-[0_4px_20px_rgba(0,0,0,0.05)]"
  >
  ...
  <motion.div
    ...
    transition={{ duration: 0.6 }}
    className="flex flex-col justify-center rounded-lg bg-gradient-to-br from-green-700 to-emerald-600 p-10 text-white shadow-[0_8px_24px_rgba(0,128,0,0.2)]"
  >
